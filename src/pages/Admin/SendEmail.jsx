        ...
        <div className="email-preview">
          ...
          <div className="preview-card">
            <div className="preview-header">
              <strong>Template ID:</strong> {import.meta.env.VITE_EMAILJS_TEMPLATE_ID}
            </div>
            <div className="preview-body">
              ...
              <hr />
              <p>To modify the email content, visit your <a href="https://dashboard.emailjs.com/" target="_blank" rel="noopener noreferrer">EmailJS Dashboard</a> and edit template <strong>{import.meta.env.VITE_EMAILJS_TEMPLATE_ID}</strong>.</p>
            </div>
          </div>
        </div>
